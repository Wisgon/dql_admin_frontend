...
<h1> dgraph_admin（element-ui） </h1>
</div>

## 地址

- [🎉 vue2.x + element-ui（免费商用，支持 PC、平板、手机）](https://chu1204505056.gitee.io/dgraph_admin-element/?hmsr=dcloud&hmpl=&hmcu=&hmkw=&hmci=)

- [⚡️ vue3.x + ant-design-vue（beta 版本，免费商用，支持 PC、平板、手机）](https://chu1204505056.gitee.io/dgraph_admin-mini/?hmsr=dcloud&hmpl=&hmcu=&hmkw=&hmci=)

- [🚀 pro 版演示地址（付费版本，支持 PC、平板、手机）](https://chu1204505056.gitee.io/admin-pro/?hmsr=dcloud&hmpl=&hmcu=&hmkw=&hmci=)

- [🌐 github 仓库地址](https://github.com/chuzhixin/dgraph_admin/?hmsr=dcloud&hmpl=&hmcu=&hmkw=&hmci=)

- [🌐 码云仓库地址](https://gitee.com/chu1204505056/dgraph_admin/?hmsr=dcloud&hmpl=&hmcu=&hmkw=&hmci=)

## 备份地址（以上地址无法使用时请访问备份站）

## 🌱 vue3.x vue3.0-antdv 分支（ant-design-vue）[点击切换分支](https://github.com/chuzhixin/dgraph_admin/tree/vue3.0-antdv)

```bash
# 克隆项目
git clone -b vue3.0-antdv https://github.com/chuzhixin/dgraph_admin.git
# 进入项目目录
cd dgraph_admin
# 安装依赖
npm i
...
## 🌱vue2.x master 分支（element-ui）[点击切换分支](https://github.com/chuzhixin/dgraph_admin/tree/master)

```bash
# 克隆项目
git clone -b master https://github.com/chuzhixin/dgraph_admin.git
# 进入项目目录
cd dgraph_admin
# 安装依赖
npm i
...
## dgraph_admin 前端讨论群 972435319，1139183756
...
```
dgraph_admin 对比其他开源 admin 框架有如下优势:
